...
Por otro lado, cp es el parámetro de complejidad α. Significa que el árbol no realizará una partición si la proporción de reducción del error es menor a 0.01. Cabe aclarar que este parámetro sirve para evitar hacer particiones que no reduzcan significativamente el error y así disminuir el tiempo de cómputo.
